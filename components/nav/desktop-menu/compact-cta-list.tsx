    ...
    <>
      {CTAs.map((cta) => (
        <div key={cta.href} className="flow-root">
          <Link href={cta.href}>
            <a className="flex items-center p-2 -m-2 text-sm font-medium text-gray-700 transition rounded-r rounded-l-3xl group hover:text-gray-900 hover:bg-black hover:bg-opacity-5 hover:shadow-inner">
              <cta.icon
