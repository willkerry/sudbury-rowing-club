      ...
      {CTAs.map((cta) => (
        <div key={cta.href} className="flow-root">
          <Link href={cta.href} passHref>
            <a className="flex group items-center p-2.5 -m-2.5 text-base font-medium text-gray-700 hover:text-gray-900 rounded hover:bg-gray-600 hover:bg-opacity-10 hover:shadow-inner transition">
              <cta.icon
