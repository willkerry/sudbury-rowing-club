  ...
  return (
    <TextPage title="Club Constitution" ogImage="/assets/og/constitution.png">
      ...
      <p>
        ...
        Trustees and held in trust for the members of the Club in accordance
        with the constitution of the Club. The Trustees shall deal with such
        property as the committee directs. Trustees shall be elected from time
      ...
      <ol type="a">
        ...
        <li>
          ...
          rowing year (The rowing year running from 1st September to 31st
          August).
        </li>
      </ol>
      ...
      <ol type="a">
        ...
        <li>
          ...
          <br />
          Do not have access to or use of club boats or members training
          equipment (including boats) and do not have voting rights.
        </li>
      </ol>
      <h3>Election of Membership</h3>
      <p>
        Membership of the Club shall be open to anyone interested in the sport
        of rowing on application, regardless of sex, age, disability, ethnicity,
      ...
      <p>
        ...
        abide by the Rules and Regulations of the Club, of British Rowing, and
        the sport of rowing.
      </p>
      <p>
        If it is considered by the Club committee that the granting or renewal
        of membership would be detrimental to the aims and objectives of the
        Club, by virtue of conduct or character likely to bring the Club or the
        sport of rowing into disrepute or for some other similar good cause, the
        Club committee shall be entitled to refuse or withdraw such membership.
        In doing so the committee shall provide full reasons for their decision,
        upon written request, and grant a right of appeal to the members.
      </p>
      <h3>Restriction</h3>
      <p>
      ...
      <p>
        Any member may resign by giving one month’s clear notice in writing to
        the Secretary; any fees already paid will not be refunded.
      </p>
      <p>
      ...
      <p>
        ...
        utilised to the full and that no member receives less favourable
      ...
      <p>
        ...
        and the protection of Vulnerable Adults, as set out by British Rowing,
        and requires all members to accept them as a condition of membership.
      </p>
      <h2>12. Safety</h2>
      <p>
      ...
      <p>
        ...
        year with the invitation. Vice-Presidents will be elected annually at
        the A.G.M.
      </p>
      ...
      <BlockHighlight>
        <p>
          ...
          together with a signed personal statement, to the Secretary at least 8
      ...
      <BlockHighlight>
        <p>
          ...
          in that current post for a maximum of five consecutive terms.
        </p>
        <p>
      ...
      <p>
        The Committee shall meet at regular intervals during the year, as
        required by the business to be transacted.
      </p>
      <p>
        Special meetings of the Committee shall be called by the Secretary on
        instructions from the Chairman, or not less than three committee
        members.
      </p>
      <p>
      ...
      <p>
        ...
        accounting records of all such transactions. He or she will present to
        the members at the AGM a balance sheet and income and expenditure
      ...
      <p>
        An Annual General Meeting shall be held in the October of each year.
        There shall be laid before the meeting a statement of accounts made up
        to the 30th September which immediately precedes the meeting.
      </p>
      <p>
        An Extraordinary General Meeting shall be called on the instructions of
        a simple majority of the Committee, or on a requisition signed by not
        less than 10% of the members of the Club entitled to vote.
      </p>
      <p>
      ...
      <p>
        Non-committee motions for discussion at Annual General Meetings, shall
        be lodged with the Secretary at least 30 days preceding the AGM, and be
        signed by 5 members entitled to vote.
      </p>
      <p>
        At any General Meeting, a resolution put to the vote of the Meeting
        shall be decided by a show of hands, of those entitled to vote, except
      ...
      <p>
        ...
        his/her absence the voting members present shall elect a Chairman for
        the meeting.
      </p>
      <p>
      ...
      <p>
        A resolution to alter, amend or rescind the constitution must be passed
        by at least 75% of the members present at the General Meeting.
      </p>
      <h2>22. Auditor</h2>
      <p>
        ...
        the Club, and report to the members on the income and expenditure
        accounts and balance sheet that are presented to the next AGM.
      </p>
      <h2>23. Distribution of Surplus Funds</h2>
      <p>
        In no circumstances can the club funds be distributed to members, and
      ...
      <p>
        ...
        Meeting convened for the purpose and, in such an event, any surplus
        assets shall be handed over to another registered CASC, a registered
        charity or the sport’s governing body as agreed by the meeting which
        formally terminates the Club, for use by them in community-related
        sports.
      </p>
      <h2>25. Power of Decision</h2>
      <p>
        The Committee shall deal with any and all matters not provided for in
        this constitution, including its interpretation. The Committee’s
