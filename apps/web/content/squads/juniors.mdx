...
We run three [Learn to Row courses](/join#l2r) each year, and we aim to coincide these
courses with the school holidays. Before each course, there is an opportunity
