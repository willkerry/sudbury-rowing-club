...
import { LearnToRowCta, LearnToRowCtaSection } from "@/components/join/cta";
...
const Join = async () => {
  ...
  return (
    <>
        ...
        <div className="mb-20 grid gap-12 md:grid-cols-2">
          <div className="prose">
            ...
            <p>
              ...
              these{" "}
              <Link href="/members/membership-rates">
      ...
      <div className="my-24" id={learnToRowId}>
        <Container>
          <SectionHeading
          ...
          <div className="mb-20 grid gap-12 md:grid-cols-2">
            <div className="prose">
              ...
              <p>
                ...
                The programme fee includes your first month’s adult membership
                to the club after which you will be given the option to continue
                your membership at the adult rate of £32 per month.
              </p>
            </div>
